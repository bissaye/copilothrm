...
import { StaffOrganisationContent } from '../../../../services/api/DTO/response';
...
export const OrganizationHeader : React.FC = () => {
    ...
    return <div className={`bg-white h-[7rem] flex flex-row justify-between items-center p-4 md:px-8 lg:gap-14 xl:px-15 w-full`}>
            ...
            <div className="w-full hidden md:flex">
                ...
                <div className='flex flex-row justify-end items-center w-full'>
                    <h1 className='font-heading capitalize font-bold text-t5 md:text-t7'>
                    {currentOrg ? currentOrg?.organisation.raisonSociale : ""}
                    </h1>
                </div>
